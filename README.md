...
### dbconfig.json
dbconfig - хранит информацию о подключении к базе данных и телеграм api;
```json
//После изменения конфигурации обязательно перезапустите программу!!!
 {
   ...
   //База данных для подключения MySQL
   "DatabaseConfig": {
     // Хост базы данных
     "Host": "127.0.0.1",
     // Порт базы данных
...
Для автоматического поиска команд используется класс "MethodFinder"
```csharp
        [Атрибуты обработки]
