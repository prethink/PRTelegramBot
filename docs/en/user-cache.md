...
The cache is keyed by the user, and what it stores is a type you define. Implement [`ITelegramCache`](api/interfaces/itelegramcache.md) and the framework takes care of the rest.
