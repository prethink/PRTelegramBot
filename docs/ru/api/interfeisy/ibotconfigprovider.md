...
Интерфейс провайдера конфигурации бота. Используется для выгрузки информации из конфигурационных файлов. Внутри библиотеки есть реализация для работы с json [BotConfigJsonProvider](../utils/botconfigjsonprovider.md)
