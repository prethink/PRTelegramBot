...
namespace PRTelegramBot.Core.Middlewares
{
    ...
    public class MiddlewareBase
    {
        ...
        public virtual async Task InvokeOnPreUpdateAsync(IBotContext context, Func<Task> next)
        {
            ...
            {
                await next();
                await InvokeOnPostUpdatesAsync(context);
            }
        }
        ...
        public virtual async Task InvokeOnPostUpdatesAsync(IBotContext context)
        {
            if (previousMiddleware != null)
                await previousMiddleware.InvokeOnPostUpdatesAsync(context);
        }
