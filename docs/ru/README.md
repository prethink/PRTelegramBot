...
* TelegramBot v22.10.2.1 [https://github.com/TelegramBots/Telegram.Bot](https://github.com/TelegramBots/Telegram.Bot)
* Поддерживается [Bot API 10.2](https://core.telegram.org/bots/api)
