![Static Badge](https://img.shields.io/badge/version-v0.8.1-brightgreen) ![Static Badge](https://img.shields.io/badge/telegram.bot-22.7.3-blue)  ![NuGet Downloads](https://img.shields.io/nuget/dt/prtelegrambot) ![NuGet Version](https://img.shields.io/nuget/v/prtelegrambot)
...
# ⚛️ Ядро фреймворка
TelegramBot v22.7.3 https://github.com/TelegramBots/Telegram.Bot
